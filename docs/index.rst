.. Research References Tracking Tool documentation master file, created by
   sphinx-quickstart on Wed Sep  2 10:36:42 2020.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to Research References Tracking Tool's documentation!
=============================================================
