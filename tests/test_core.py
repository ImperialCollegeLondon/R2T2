...
class TestAddReference:
    ...
    def test_captures_multiple_refs(self, bib_with_tracking):
        ...
        assert "[plain]Reference 1" in bib_with_tracking.references
        assert "[plain]Reference 2" in bib_with_tracking.references
        assert len(bib_with_tracking.references) == 2
    ...
    def test_add_reference_from_bibtex(self, bib_with_tracking, decorated_with_bibtex):
        decorated_with_bibtex()
        assert "[bibtex]Cesar2013" in bib_with_tracking.references[-1]
